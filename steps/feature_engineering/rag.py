...
def chunk_and_embed(
    ...
    step_context.add_output_metadata(output_name="embedded_chunks", metadata=metadata)
...
def _add_embedding_metadata(embedded_chunks: list[EmbeddedChunk], metadata: dict) -> dict:
