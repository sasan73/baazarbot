...
from baazarbot.application.networks.embeddings import EmbeddingModelSingleton
from baazarbot.domain.exceptions import ImproperlyConfigured
from baazarbot.domain.types import DataCategory
from baazarbot.infrastructure.db.qdrant import connection
